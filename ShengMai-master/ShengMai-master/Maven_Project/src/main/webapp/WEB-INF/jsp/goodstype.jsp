...
<title>My JSP 'foodtype.jsp' starting page</title>
		...
		<div id="TitleArea_Title">
			<div id="TitleArea_Title_Content">
				<img border="0" width="13" height="13"
					src="images/title_arrow.gif" /> 菜系列表
			</div>
		</div>
	...
	<div id="MainArea">
		<table class="MainArea_Content" align="center" cellspacing="0"
			...
			<tbody id="TableData">
				...
				<tr>
					<td>1</td>
					<td>粤菜</td>
					<td><a href="redirect.do?page=updateFoodType" class="FunctionButton">更新</a>
				...
				<tr>
					<td>2</td>
					<td>川菜</td>
					<td><a href="#" class="FunctionButton">更新</a> <a href="#"
		...
		<div id="TableTail" align="center">
			<div class="FunctionButton">
				<a href="redirect.do?page=saveFoodType">添加</a>
			</div>
		</div>
	</div>
</body>
