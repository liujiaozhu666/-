...
<body>
	...
	<div id="MainArea">
		<!-- 表单内容 -->
		<form action="insertShops.do" method="post" enctype="multipart/form-data">
			<!-- 本段标题（分段标题） -->
				...
				<div class="ItemBlock">
					<div class="ItemBlock2">
						<table cellpadding="0" cellspacing="0" class="mainForm">
							<tr>
								<td width="80px">商户logo</td>
								<td><input type="file" name="logo" class="InputStyle" /></td>
							</tr>
							<tr>
							...
							<tr>
								<td width="80px">商户距离</td>
								<td><input type="text" name="distance" class="InputStyle" /></td>
							</tr>
							<tr>
								<td width="80px">商户总销量</td>
								<td><input type="text" name="sales" class="InputStyle" /></td>
							</tr>
							<tr>
								<td width="80px">商户促销活动</td>
								<td><input type="text" name="activity" class="InputStyle" /></td>
							</tr>
						</table>
					</div>
				</div>
