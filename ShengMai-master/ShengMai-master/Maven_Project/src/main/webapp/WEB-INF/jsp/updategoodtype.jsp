...
<title>My JSP 'updateFoodType.jsp' starting page</title>
		...
		<div id="TitleArea_Title">
			<div id="TitleArea_Title_Content">
				...
				<img border="0" width="13" height="13"
					src="images/title_arrow.gif" /> 更新菜系
		...
		<form action="#" method="post">
			...
			<div class="ItemBlock_Title">
				<img width="4" height="7" border="0"
					src="images/item_point.gif"> 菜系信息&nbsp;
			</div>
			<!-- 本段表单字段 -->
						...
						<table cellpadding="0" cellspacing="0" class="mainForm">
							<tr>
								...
								<td><input type="text" name="name" class="InputStyle"
									value="粤菜" /> * <input type="hidden" name="cid" value="1" /></td>
							</tr>
						</table>
					</div>
				</div>
