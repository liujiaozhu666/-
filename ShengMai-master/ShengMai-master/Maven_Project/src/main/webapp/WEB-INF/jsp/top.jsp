...
#Head_1 {
	background: url("images/img/top_head1_bg.gif") repeat-x scroll 0 0
		transparent;
	height: 64px;
	margin: 0 auto;
	width: 100%;
...
#Head_2 {
	background: url("images/img/top_head2_bg.gif") repeat-x scroll 0 0
		transparent;
	...
	<div id="Head_2">
		...
		<div id="Head2_FunctionList">
			...
			<a href="javascript: window.parent.right.history.go(0);"> <img
				src="images/Header_refresh.gif" width="24" height="24"
				style="margin-top: -8px;" /> <b>刷新(IE、Chrome)</b>
			</a> <a href="javascript: window.parent.right.location.reload(true);">
				<img src="images/Header_refresh.gif" width="24" height="24"
